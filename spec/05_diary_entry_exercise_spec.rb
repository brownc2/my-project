...
RSpec.describe DiaryEntry do
  ...
  diary_entry = DiaryEntry.new("day ",para)
  ...
  #it "return a string containing the text the reader has time to read in the given number of minutes when called more than once" do
   # diary_entry = DiaryEntry.new("day one",para)
    #diary_entry.count_words
    #diary_entry.reading_chunk(10,5)
    #result = diary_entry.reading_chunk(10,5)
    #expect(result).to eq "the latter using artificial intelligence to render high-quality images more efficiently. While all four of Nvidia’s new 20 Series graphics cards are capable of delivering both of theses – and older cards will support ray tracing to varying degrees later in the year – the RTX 2080 Ti boasts the best specs of them all.
  
  #  If you want the ultimate performance for ray tracing and DLSS, the RTX 2080 Ti is undoubtedly the best consumer"
 # end
